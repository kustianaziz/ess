...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware('role:admin|hrd_finance|manager')->prefix('keuangan')->name('keuangan.')->group(function () {
        ...
        Route::post('/tagihan-bulanan/{id}/update-details', [\App\Http\Controllers\MonthlyBillController::class, 'updatePaymentDetails'])->name('tagihan-bulanan.update-details');
