...
<h4 align="center" style="margin-top:0px;margin-bottom:2px;font-weight:bold;">LAPORAN POSISI KEUANGAN</h4>
<h4 align="center" style="margin-top:0px;margin-bottom:15px;font-weight:bold;">PER <?=$str_date?></h4>
...
?>
    ...
    foreach($get_data_coa_kategori[$kat_id] as $row_coa) {
        ...
        while (!empty($stack) && end($stack)['level_parent'] >= $level) {
            ...
            if (in_array($parent['id'], $path_setting_aktiva)) {
                $p_c1 += ($c1['saldocoakategori'][4] - $c1['saldocoakategori'][5]);
                $p_c2 += ($c2['saldocoakategori'][4] - $c2['saldocoakategori'][5]);
                $p_c3 += ($c3['saldocoakategori'][4] - $c3['saldocoakategori'][5]);
            }
        ...
        if ($setting_aktiva['coa_aktiva_tidak_terikat_tahun_berjalan'] == $row_coa['id']) {
            $v_c1 = $c1['saldocoakategori'][4] - $c1['saldocoakategori'][5];
            $v_c2 = $c2['saldocoakategori'][4] - $c2['saldocoakategori'][5];
            $v_c3 = $c3['saldocoakategori'][4] - $c3['saldocoakategori'][5];
        } else if (in_array($row_coa['id'], $path_setting_aktiva)) {
            $v_c1 += ($c1['saldocoakategori'][4] - $c1['saldocoakategori'][5]);
            $v_c2 += ($c2['saldocoakategori'][4] - $c2['saldocoakategori'][5]);
            $v_c3 += ($c3['saldocoakategori'][4] - $c3['saldocoakategori'][5]);
        }
