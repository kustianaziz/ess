            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Rp 0"
                  class="w-full text-xs sm:text-sm border-slate-200 rounded-xl focus:ring-orange-500 focus:border-orange-500 font-semibold text-orange-700"
                />
              </div>
              <div class="sm:col-span-2">
          ...
          <div class="bg-slate-50 p-4 sm:p-6 rounded-2xl space-y-4 border border-slate-200/60">
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 text-xs sm:text-sm">
              ...
              <div>
                ...
                <span class="font-bold text-orange-600 text-sm sm:text-base">{{ formatCurrency(form.estimated_cost) }}</span>
              </div>
              <div>
            ...
            <div class="pt-3 border-t border-slate-200/60">
              ...
              <p class="text-xs sm:text-sm text-slate-700 font-medium mt-1">{{ form.purpose }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="pt-6 border-t border-slate-100 flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-between gap-3">
          ...
          <div class="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
            ...
            <button
              ...
              type="button"
              @click="nextStep"
              class="flex-1 sm:flex-initial px-6 py-2.5 rounded-xl bg-orange-500 text-white text-xs sm:text-sm font-semibold hover:bg-orange-600 shadow-lg shadow-orange-500/30 transition-all flex items-center justify-center gap-2"
            >
