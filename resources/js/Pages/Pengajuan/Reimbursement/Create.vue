            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  disabled
                  class="w-full text-sm bg-slate-50 border-slate-200 rounded-xl text-slate-600 font-medium cursor-not-allowed"
                />
              </div>
              <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
              <div>
                ...
                <input
                  ...
                  class="w-full text-sm border-slate-200 rounded-xl focus:ring-emerald-500 focus:border-emerald-500"
                />
              </div>
              <div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Rp 0"
                  class="w-full text-sm border-slate-200 rounded-xl focus:ring-emerald-500 focus:border-emerald-500 font-semibold text-emerald-700"
                />
              </div>
              <div class="md:col-span-3">
                ...
                <textarea
                  ...
                  class="w-full text-sm border-slate-200 rounded-xl focus:ring-emerald-500 focus:border-emerald-500 resize-none"
                ></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="bg-slate-50 p-6 rounded-2xl space-y-4 border border-slate-200/60">
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
              ...
              <div>
                ...
                <span class="font-bold text-emerald-600 text-base">{{ formatCurrency(form.amount) }}</span>
              </div>
            </div>

            <div class="pt-3 border-t border-slate-200/60">
              <span class="text-xs text-slate-400 block">Keterangan</span>
              <p class="text-sm text-slate-700 font-medium mt-1">{{ form.description }}</p>
            </div>
            ...
            <div class="pt-3 border-t border-slate-200/60" v-if="form.attachments.length">
              ...
              <p class="text-sm text-slate-800 font-semibold mt-1">{{ form.attachments.length }} File Terlampir</p>
            </div>
          </div>
        </div>
        ...
        <div class="pt-6 border-t border-slate-100 flex items-center justify-between">
          ...
          <div class="flex items-center gap-3">
            ...
            <button
              ...
              type="button"
              @click="nextStep"
              class="px-6 py-2.5 rounded-xl bg-emerald-600 text-white text-sm font-semibold hover:bg-emerald-700 shadow-lg shadow-emerald-600/30 transition-all flex items-center gap-2"
            >
